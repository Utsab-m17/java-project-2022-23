...
public class EmployeeDemo {
	...
	public static void main(String[] args) {
		...
		List<Double> listOfITDeptSalaries = listOfEmployee.stream()
				.filter(o -> o.getDepartmentString().equals("IT"))
		...
		List<Employee> listOfEmployeesWithIncreasedSalary = listOfEmployee.stream()

				.filter(emp -> emp.getDepartmentString().equals("IT"))
		...
		listOfEmployeesWithIncreasedSalary.forEach(System.out::println);
